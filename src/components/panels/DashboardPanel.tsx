...
export default function DashboardPanel({ agents, teamMemberIds, onAddAgent, onRemoveAgent }: {
  ...
  onAddAgent: (agent: TeamMember) => Promise<void> | void;
  onRemoveAgent: (agent: TeamMember) => Promise<void> | void;
}) {
