...
export default function HubPanelView(props: any) {
  ...
  return (
    <div className="glass-card fade-in" style={{ animationDelay: "0.1s" }}>
      ...
      {hubTab === "branches" && <BranchesTab />}
      {hubTab === "system" && <SystemTab />}
      ...
      {hubTab === "tools" && <McpToolsPanel />}

      {hubTab === "channels" && (
        <ChannelsTab
          channelWorkspaces={channelWorkspaces}
          channelRenameDrafts={channelRenameDrafts}
          setChannelRenameDrafts={setChannelRenameDrafts}
          renameChannelWorkspace={renameChannelWorkspace}
          deleteChannelWorkspace={deleteChannelWorkspace}
          refreshChannelWorkspaces={refreshChannelWorkspaces}
          channelConnected={channelConnected}
          channelConnecting={channelConnecting}
          connectChannelWorkspace={connectChannelWorkspace}
          grokWorkspace={grokWorkspace ?? ""}
        />
      )}
