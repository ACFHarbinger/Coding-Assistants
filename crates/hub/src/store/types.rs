//! Shared Hub record types: enums, structs, and pure helpers that
//! cross the IPC/CLI boundary (the types half of the old
//! store/mod.rs, split out for the 500-LoC cap, #158).
//!
//! HubStore itself and the private schema helpers stay in the
//! parent module; submodules reach everything here through the
//! parent's pub-use re-export.
