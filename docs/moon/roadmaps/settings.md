...
- S6: [#132](https://github.com/ACFHarbinger/Coding-Assistants/issues/132) · remainder implemented (Muse, 2026-09-11): hard-delete workspace transcript/memory purges + combined data purge with audit events, shared typed-confirmation box (Cancel-first, red/amber), profile-deletion wiring; awaiting Chat/Codex review
