...
| U10 | Orchestrate team chat | Write/send message actions, sender-attributed conversation feed, explicit enrollment, team/private routing, and private-content redaction | 🚧 **Partial** · Durable hub refresh, recipient selector, team fan-out, and private metadata-only rendering are available; live presence and richer threading remain |
