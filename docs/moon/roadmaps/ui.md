...
| U10 | Orchestrate team chat | Write/send message actions, sender-attributed conversation feed, explicit enrollment, team/private routing, and private-content redaction | 🚧 **Partial** · Slack-like channels, persisted roster, and team-wide wakes are available; desktop enroll/unenroll controls and richer threading remain |
