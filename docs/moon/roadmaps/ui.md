...
| U10 | Orchestrate team chat | Write/send message actions, sender-attributed conversation feed, and explicit enrollment for spawned or existing agents | 🚧 **Partial** · Durable hub/private-message refresh and participant enrollment are available; live presence and richer Slack-style threading remain |
